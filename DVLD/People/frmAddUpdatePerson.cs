    ...
    public partial class frmAddUpdatePerson : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
           ...
           if (! _HandlePersonImage())
            ...
            if (_Person.Save())
            {
                HandleTheFormAfterSaveInfoPerson();
        ...
        private void HandleTheFormAfterSaveInfoPerson()
        {
            if (_Mode == enMode.AddNew)
            {
                //change form mode to update if mode was AddNew.
                _Mode = enMode.Update;
            ...
            {
                this.Text = "The Info Updated Successfully";
                lblTitle.Text = "The Info Updated Successfully";
                lblTitle.ForeColor = Color.Green;

                // we disable all controls without button close.
        ...
        {
            llSetImage_LinkClicked(null, null);
        }
